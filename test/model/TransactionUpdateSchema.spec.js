...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FuxionServer.TransactionUpdateSchema();
  });
  ...
  describe('TransactionUpdateSchema', function() {
    it('should create an instance of TransactionUpdateSchema', function() {
      // uncomment below and update the code to test TransactionUpdateSchema
      //var instance = new FuxionServer.TransactionUpdateSchema();
      //expect(instance).to.be.a(FuxionServer.TransactionUpdateSchema);
    });
