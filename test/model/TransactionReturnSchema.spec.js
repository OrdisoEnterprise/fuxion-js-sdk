...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FuxionServer.TransactionReturnSchema();
  });
  ...
  describe('TransactionReturnSchema', function() {
    it('should create an instance of TransactionReturnSchema', function() {
      // uncomment below and update the code to test TransactionReturnSchema
      //var instance = new FuxionServer.TransactionReturnSchema();
      //expect(instance).to.be.a(FuxionServer.TransactionReturnSchema);
    });
