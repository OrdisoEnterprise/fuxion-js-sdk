...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FuxionServer.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new FuxionServer.HTTPValidationError();
      //expect(instance).to.be.a(FuxionServer.HTTPValidationError);
    });
