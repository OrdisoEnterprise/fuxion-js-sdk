...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FuxionServer.AccountReturnSchema();
  });
  ...
  describe('AccountReturnSchema', function() {
    it('should create an instance of AccountReturnSchema', function() {
      // uncomment below and update the code to test AccountReturnSchema
      //var instance = new FuxionServer.AccountReturnSchema();
      //expect(instance).to.be.a(FuxionServer.AccountReturnSchema);
    });
