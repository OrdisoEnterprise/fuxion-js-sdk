...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FuxionServer.BodyResetResetPasswordAuthResetPasswordPost();
  });
  ...
  describe('BodyResetResetPasswordAuthResetPasswordPost', function() {
    it('should create an instance of BodyResetResetPasswordAuthResetPasswordPost', function() {
      ...
      //var instance = new FuxionServer.BodyResetResetPasswordAuthResetPasswordPost();
      //expect(instance).to.be.a(FuxionServer.BodyResetResetPasswordAuthResetPasswordPost);
    });
