...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FuxionServer.BearerResponse();
  });
  ...
  describe('BearerResponse', function() {
    it('should create an instance of BearerResponse', function() {
      // uncomment below and update the code to test BearerResponse
      //var instance = new FuxionServer.BearerResponse();
      //expect(instance).to.be.a(FuxionServer.BearerResponse);
    });
