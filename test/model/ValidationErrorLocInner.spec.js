...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FuxionServer.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function() {
    it('should create an instance of ValidationErrorLocInner', function() {
      ...
      //var instance = new FuxionServer.ValidationErrorLocInner();
      //expect(instance).to.be.a(FuxionServer.ValidationErrorLocInner);
    });
