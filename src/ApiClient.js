...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://192.168.0.31:1524/fuxion-server') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://192.168.0.31:1524/fuxion-server
         */
    ...
    */
    callApi(path, httpMethod, pathParams,
        ...
        if (contentType === 'application/x-www-form-urlencoded') {
            request.send(JSON.stringify(this.normalizeParams(formParams)));
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "http://192.168.0.31:1524/fuxion-server",
